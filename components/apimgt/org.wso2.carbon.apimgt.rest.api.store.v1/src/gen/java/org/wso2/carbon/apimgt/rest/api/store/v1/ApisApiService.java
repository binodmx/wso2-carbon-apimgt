...
public interface ApisApiService {
      ...
      public Response apisApiIdSwaggerGet(String apiId, String labelName, String environmentName, String clusterName, String ifNoneMatch, String xWSO2Tenant, String xWSO2TenantQ, MessageContext messageContext) throws APIManagementException;
