...
@PrepareForTest({RESTUtils.class, Utils.class, GatewayUtils.class})
public class DefaultAPIHandlerTest {
    ...
    public void testHandleRequestIn() {
        ...
        PowerMockito.when(RESTUtils.getFullRequestPath(messageContext)).thenReturn("/api1/abc/cde?c=a");
