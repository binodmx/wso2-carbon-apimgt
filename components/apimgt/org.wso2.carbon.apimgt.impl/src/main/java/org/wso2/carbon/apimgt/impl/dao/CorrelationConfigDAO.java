...
public class CorrelationConfigDAO {
    ...
    private static final String UPDATE_ERROR_MESSAGE = "Failed to update correlation configs";
    ...
    public boolean updateCorrelationConfigs(List<CorrelationConfigDTO> correlationConfigDTOList)
        ...
        List<String> disabledComponentList = new ArrayList<>(correlationComponents);
        ...
        try (Connection connection = APIMgtDBUtil.getConnection()) {
            ...
            try (PreparedStatement preparedStatementConfigs = connection.prepareStatement(queryConfigs)) {
                for (CorrelationConfigDTO correlationConfigDTO : correlationConfigDTOList) {
                    ...
                    disabledComponentList.remove(componentName);
                ...
                for (String component : disabledComponentList) {
                    preparedStatementConfigs.setString(1, "false");
                    preparedStatementConfigs.setString(2, component);
                    preparedStatementConfigs.addBatch();
                }
                ...
                throw new APIManagementException(UPDATE_ERROR_MESSAGE, e);
            }
